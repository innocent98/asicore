    ...
    <div className="about">
      <section>
        <div className="wrapper">
          <h2>About Us</h2>
          <p>
            The team behind ASI CORE is made up of experienced and knowledgeable
            professionals who are passionate about blockchain technology and its
            potential to transform the world of finance. The team is led by a
            group of experts with a deep understanding of the cryptocurrency
            market and years of experience in developing blockchain-based
            ...
            built on the principles of transparency, community involvement, and
            innovation. <br />
            ...
            CORE community. <br />
            <br /> The marketing team is skilled at building strong and engaged
            communities around blockchain projects. They are committed to
            ensuring that ASI CORE has a vibrant and active community of
